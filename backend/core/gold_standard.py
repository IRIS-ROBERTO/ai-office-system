...
def build_gold_standard_prompt(*, role: str, agent_id: str) -> str:
    return (
        ...
        "- Auto melhoria da plataforma IRIS: commitar no repositorio principal do IRIS.\n"
        "- Produto novo, MVP standalone, oportunidade de mercado ou spin-off: criar repositorio proprio "
        "dentro de GENERATED_PROJECTS_ROOT, com commits exclusivos e remoto GitHub proprio.\n\n"
